# Recursos — Disciplina de Texturização

Levantamento de todos os recursos que o professor precisa preparar previamente, extraído dos 17 planos de aula. Itens de infraestrutura genérica (computadores, projetor) não estão incluídos.

| ID | Nome do arquivo (sugerido) | Plano de aula | Softwares | Semana | Breve descrição |
|---|---|---|---|---|---|
| R01 | Exemplos_Kits_Modulares_Referencia | Semana 01 | — (imagens/vídeo) | 1 | 3 kits modulares prontos (Medieval, Sci-Fi, Pós-apocalíptico) para demonstração |
...
| R14 | demo_asset_uv.obj / .fbx | Semana 08 | Blender / 3D Coat | 8 | Asset com UV aberto, exportado para importação de demonstração no 3D Coat |
| R15 | Pasta_Exportacao_3DCoat (modelo) | Semana 08 | 3D Coat | 8 | Estrutura de pasta modelo `[DEMO]_3DCoat_Exportacao/` para organizar as exportações |
| R16 | demo_base_pintada.3b | Semana 09 | 3D Coat | 9 | Asset com camadas base (Cor/Roughness/Metallic) pintadas, pronto para receber detalhes |
| R17 | Refs_Desgaste_por_Tema.zip | Semana 09 | — (imagens) | 9 | 10–15 imagens de superfícies desgastadas, organizadas por tema da turma |
| R18 | demo_pedra_stencil_base.3b | Semana 10 | 3D Coat | 10 | Asset de pedra com camadas base pintadas, pronto para receber stencils |
| R19 | Colecao_Stencils.zip | Semana 10 | 3D Coat / Krita | 10 | 15–20 stencils (rachaduras, corrosão, símbolos) em escala de cinza |
| R20 | demo_lowpoly_highpoly.blend | Semana 11 | Blender | 11 | Par de meshes (baixa/alta poligonagem) do mesmo asset, prontos para bake |
| R21 | demo_idmap_curvature.blend | Semana 12 | Blender / 3D Coat | 12 | Asset com grupos de material nomeados e detalhe de aresta para ID Map/Curvature |
| R22 | demo_3assets_atlas.blend | Semana 13 | Blender | 13 | 3 assets de tamanhos distintos, cada um com UV individual, para combinar em atlas |
