...
5. Refletir criticamente sobre a própria trajetória de aprendizagem ao longo das 17 semanas, identificando o que mudou na forma de tomar decisões técnicas e artísticas desde a Semana 1.
...
> 🔴 **Crítica Formal — CF6 / Projeto Final.** Esta é a única semana em que **todos os 10 critérios da rubrica** recebem nota formal simultaneamente, incluindo C10 (Participação nas Critiques), que nas CFs anteriores era apenas observado. A ponderação desta CF6 segue a tabela de pesos do Projeto Final definida na Rubrica Mestre — não é uma média simples dos critérios, e não é a mesma ponderação usada no Portfolio de Artefatos (PA).

| Critério | Peso no PF (CF6) | O que observar na defesa |
|---|---|---|
...
| C5 — Texturização | 14% | Maior peso da CF6 — profundidade narrativa do desgaste e sujeira, leitura à distância de uso |
...
*"Vocês não precisam explicar cada uma das 17 semanas. Escolham o que for mais representativo do trabalho de vocês — a apresentação é uma escolha editorial, não um relatório completo."*
...
Revisar rapidamente a tabela de critérios ativos na CF6: hoje, pela primeira vez, todos os 10 critérios recebem nota simultaneamente, incluindo C10 (Participação), que até agora era só observado. Mostrar a tabela de pesos do Projeto Final e destacar que C5 (Texturização) tem o maior peso — coerente com o fato de ser o núcleo da disciplina.
...
Conforme o cronograma da disciplina, não há novo conteúdo técnico a demonstrar na Semana 17. Em vez de uma demonstração de ferramenta, o professor usa este bloco para apresentar um exemplo de Kit Modular completo (de uma coorte anterior, ou um kit de referência preparado antecipadamente) como parâmetro de padrão esperado.
...
Informar prazos administrativos remanescentes (se houver: lançamento de notas, prazo de recurso, disponibilização de feedback escrito individual). Agradecer o semestre de trabalho e reforçar que o portfólio produzido — Kit Modular completo, documentado e funcional na Unity — é, a partir de hoje, material de portfólio profissional do estudante.
...
Com 17 semanas de arquivos acumulados, há risco de algum estudante ter problema técnico no dia da apresentação. Estratégia: exigir teste prévio de abertura dos arquivos antes da aula (idealmente na Semana 16 ou por comunicado); no dia, ter um plano B com renders/screenshots já exportados como apoio caso o projeto Unity não abra ao vivo.
...
| Cena Unity montada, com materiais, lightmap e renders finais (produzidos na Semana 16) | C8 — Integração na Unity | O kit funciona como um produto entregável, sem retrabalho necessário, sob iluminação coerente? |
...
| Projeto Unity com a cena completa montada, materiais configurados e lightmap baked (produzido na Semana 16) | Pasta de projeto Unity, nomeada `[Nome]_Kit_Unity_Final` | Até o início da própria apresentação |
